...
FHIR.oauth2.ready().then(function(client) {
  ...
  client.request("Observation?" + query, {
    ...
    function(ob) {
      ...
      if (typeof systolicbps != 'undefined' && systolicbps.length > 0) {
        p.sys = getQuantityValueAndUnit(systolicbps[0]);
      } else {
        p.sys = 'undefined'
      }
  
      if (typeof diastolicbps != 'undefined' && diastolicbps.length > 0) {
        p.dia = getQuantityValueAndUnit(diastolicbps[0]);
      } else {
        p.dia = 'undefined'
      }
